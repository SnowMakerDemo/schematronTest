 ...
 */
public final class SchematronValidateUtil
{
  ...
  public static SchematronOutputType validateXMLViaPureSchematron2 (@Nonnull final File aSchematronFile,
                                                       @Nonnull final File aXMLFile) throws Exception
  {
    ...
    return aBoundSchema.validateComplete (aXMLNode, FileHelper.getAsURLString (aXMLFile));
  }
